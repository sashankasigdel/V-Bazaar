...
const UI_ICON_PATHS = {
  ...
  tag: '<path d="M3 11.5V4h7.5L21 14.5a2 2 0 0 1 0 2.8l-5.7 5.7a2 2 0 0 1-2.8 0L3 13.5z"/><circle cx="7.5" cy="8.5" r="1.4" fill="currentColor" stroke="none"/>',
  export: '<path d="M12 3v12"/><path d="M7 8l5-5 5 5"/><path d="M4 15v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4"/>',
  edit: '<path d="M4 20h4L19.5 8.5a2.1 2.1 0 0 0-3-3L5 17v3z"/><path d="M14 6.5l3 3"/>',
  ...
  restore: '<path d="M3 11a9 9 0 1 1 2.6 6.3"/><path d="M3 4v7h7"/>',
  archiveBox: '<rect x="3" y="4" width="18" height="5" rx="1.3"/><path d="M5 9v9a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V9"/><path d="M10 13h4"/>',
  key: '<circle cx="8" cy="15" r="4"/><path d="M11 12l9-9"/><path d="M16 7l3 3M13 10l2.5 2.5"/>',
  trash: '<path d="M4 7h16"/><path d="M9 7V4.5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1V7"/><path d="M6 7l1 13a1.5 1.5 0 0 0 1.5 1.5h7a1.5 1.5 0 0 0 1.5-1.5L18 7"/>',
  ban: '<circle cx="12" cy="12" r="9"/><path d="M5.5 5.5l13 13"/>',
  eyeOff: '<path d="M3 3l18 18"/><path d="M10.6 5.1A10.7 10.7 0 0 1 12 5c5 0 9 4 10.5 7-0.6 1.2-1.5 2.5-2.7 3.6M6.6 6.6C4.4 8 2.8 10 1.5 12c1.5 3 5.5 7 10.5 7 1.4 0 2.7-0.3 3.9-0.9"/><path d="M9.9 10a3 3 0 0 0 4.1 4.1"/>',
...
const API = {
  ...
  patchBusiness: (slug, data) => http.patch(`/businesses/my/${slug}/`, data),
